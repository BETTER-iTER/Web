...
const ResetPassword = () => {
    ...
    return (
        ...
        <ButtonWithInput
          ...
          error={
            validatePassword(password) || password.length == 0 ? undefined : '비밀번호 형식에 맞게 입력해주세요'
          }
        ...
        <ButtonBody>
            <Button disabled={!(checkPassword === password && checkPassword && password)} onClick={() => console.log("비번 재설정 버튼")} children="비밀번호 재설정" />
        </ButtonBody>
        </Body>
        </>
